...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    bookingLargeParty: "Online reservations support up to 6 guests. For larger groups, please contact Riverside Terrace at (+84) 911500440 or email contact@riversideterrace.local.",
    bookingDate: "Date",
    bookingStart: "Start",
    bookingEnd: "End",
